...
module.exports = function (/* ctx */) {
  ...
  const envs = appEnvs.get(process.env.ENV, true)
  ...
  return {
    ...
    pwa: {
      ...
      manifest: {
        name: 'Test Rapidi Strutture Residenziali',
        short_name: 'Test Rapidi Strutture Residenziali',
        description: 'Test Rapidi Strutture Residenziali',
        display: 'standalone',
